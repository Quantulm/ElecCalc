...
class Transportation(models.Model):
    ...
    transport_consumption = models.FloatField(
        "Energy consumption per distance (kWh/km)"
    )
...
class Faculty(models.Model):
    ...
    lecture_frequency = models.FloatField(
        "Number of lectures attended on daily average by faculty"
    )
    ...
    dev_usage = models.FloatField(
        "Usage of electronic devices (%) per faculty", blank=True
    )
    ...
    elec_dev_freq = models.FloatField(
        "frequency of use of electronic devices by faculty"
    )
